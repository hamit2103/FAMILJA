...
const I18N = {
  sq: {
    ...
    "share.text":"Shkarko dhe instalo APK-në ANGEL në Android.","share.copied":"Linku i APK-së u kopjua. Tani mund ta dërgosh.",
  ...
  de: {
    ...
    "share.text":"Lade die ANGEL-APK herunter und installiere sie auf Android.","share.copied":"Der APK-Link wurde kopiert. Du kannst ihn jetzt senden.",
  ...
  tr: {
    ...
    "share.text":"ANGEL APK dosyasını indir ve Android'e yükle.","share.copied":"APK bağlantısı kopyalandı. Şimdi gönderebilirsin.",
...
const EXTRA_I18N = {
  ...
  de:{
    ...
    "clock.title":"ANGEL Uhr","clock.description":"Modernes Widget für den Startbildschirm. Die Uhr bleibt sichtbar, auch wenn die App geschlossen ist.","clock.germany":"Deutschland","clock.kosovo":"Kosovo","clock.turkey":"Türkei","clock.newyork":"New York","clock.add":"Uhr zum Bildschirm hinzufügen","clock.androidHint":"Tippe unter Android auf die Schaltfläche, um das Widget zum Startbildschirm hinzuzufügen.","clock.pinRequest":"Android öffnet die Widget-Anfrage. Wähle „Hinzufügen“.","clock.nativeOnly":"Das Startbildschirm-Widget ist in der Android-Version von ANGEL verfügbar.",
  ...
  tr:{
    ...
    "clock.title":"ANGEL Saat","clock.description":"Ana ekran için modern widget. Uygulama kapalıyken de saat görünür.","clock.germany":"Almanya","clock.kosovo":"Kosova","clock.turkey":"Türkiye","clock.newyork":"New York","clock.add":"Saati ekrana ekle","clock.androidHint":"Android'de widgetı ana ekrana eklemek için düğmeye bas.","clock.pinRequest":"Android widget ekleme isteğini açacak. “Ekle”yi seç.","clock.nativeOnly":"Ana ekran widgetı ANGEL'nin Android sürümünde kullanılabilir.",
  ...
  hr:{
    ...
    "clock.title":"ANGEL Sat","clock.description":"Moderan widget za početni zaslon. Sat ostaje vidljiv i kada je aplikacija zatvorena.","clock.germany":"Njemačka","clock.kosovo":"Kosovo","clock.turkey":"Turska","clock.newyork":"New York","clock.add":"Dodaj sat na zaslon","clock.androidHint":"Na Androidu pritisni gumb za dodavanje widgeta na početni zaslon.","clock.pinRequest":"Android će otvoriti zahtjev za widget. Odaberi “Dodaj”.","clock.nativeOnly":"Widget početnog zaslona dostupan je u Android verziji ANGEL.",
  ...
  fr:{
    ...
    "clock.title":"Horloge ANGEL","clock.description":"Widget moderne pour l'écran d'accueil. L'horloge reste visible même lorsque l'application est fermée.","clock.germany":"Allemagne","clock.kosovo":"Kosovo","clock.turkey":"Turquie","clock.newyork":"New York","clock.add":"Ajouter l'horloge à l'écran","clock.androidHint":"Sur Android, appuyez sur le bouton pour ajouter le widget à l'écran d'accueil.","clock.pinRequest":"Android ouvrira la demande de widget. Choisissez « Ajouter ».","clock.nativeOnly":"Le widget d'écran d'accueil est disponible dans la version Android de ANGEL.",
