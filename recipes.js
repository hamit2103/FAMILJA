...
const T={
 ...
 de:{tab:"Rezepte",title:"Kochen / Rezepte",sub:"Küche wählen und Rezept finden.",xk:"Kosovarische Rezepte",tr:"Türkische Rezepte",search:"Rezept suchen...",all:"Alle",fav:"Favoriten",ing:"Zutaten",steps:"Zubereitung",people:"Personen",min:"Min.",video:"Video ansehen",back:"← Rezepte",empty:"Keine Rezepte hier.",add:"Rezept hinzufügen",save:"Rezept speichern",del:"Löschen",saved:"Rezept gespeichert.",fail:"Speichern fehlgeschlagen.",meat:"Fleisch",soup:"Suppen",dough:"Teigwaren",dessert:"Desserts",breakfast:"Frühstück",other:"Andere"},
  it:{tab:"Ricette",title:"Cucina / Ricette",sub:"Scegli la cucina e trova una ricetta.",xk:"Ricette kosovare",tr:"Ricette turche",search:"Cerca ricetta...",all:"Tutte",fav:"Preferite",ing:"Ingredienti",steps:"Preparazione",people:"persone",min:"min",video:"Guarda il video",back:"← Ricette",empty:"Nessuna ricetta qui.",add:"Aggiungi ricetta",save:"Salva ricetta",del:"Elimina",saved:"Ricetta salvata.",fail:"Salvataggio non riuscito.",meat:"Carne",soup:"Zuppe",dough:"Impasti",dessert:"Dolci",breakfast:"Colazione",other:"Altro"},
 hr:{tab:"Recepti",title:"Kuhanje / Recepti",sub:"Odaberi kuhinju i pronađi recept.",xk:"Kosovski recepti",tr:"Turski recepti",search:"Traži recept...",all:"Sve",fav:"Omiljeni",ing:"Sastojci",steps:"Priprema",people:"osoba",min:"min",video:"Pogledaj video",back:"← Recepti",empty:"Ovdje nema recepata.",add:"Dodaj recept",save:"Spremi recept",del:"Izbriši",saved:"Recept je spremljen.",fail:"Spremanje nije uspjelo.",meat:"Meso",soup:"Juhe",dough:"Tijesto",dessert:"Deserti",breakfast:"Doručak",other:"Ostalo"},
 ar:{tab:"وصفات",title:"الطبخ / الوصفات",sub:"اختر المطبخ وابحث عن الوصفة.",xk:"وصفات كوسوفية",tr:"وصفات تركية",search:"ابحث عن وصفة...",all:"الكل",fav:"المفضلة",ing:"المكونات",steps:"طريقة التحضير",people:"أشخاص",min:"دقيقة",video:"شاهد الفيديو",back:"← الوصفات",empty:"لا توجد وصفات هنا.",add:"إضافة وصفة",save:"حفظ الوصفة",del:"حذف",saved:"تم حفظ الوصفة.",fail:"تعذر الحفظ.",meat:"لحوم",soup:"شوربات",dough:"معجنات",dessert:"حلويات",breakfast:"فطور",other:"أخرى"},
 fr:{tab:"Recettes",title:"Cuisine / Recettes",sub:"Choisissez une cuisine et trouvez une recette.",xk:"Recettes kosovares",tr:"Recettes turques",search:"Rechercher une recette...",all:"Toutes",fav:"Favoris",ing:"Ingrédients",steps:"Préparation",people:"personnes",min:"min",video:"Voir la vidéo",back:"← Recettes",empty:"Aucune recette ici.",add:"Ajouter une recette",save:"Enregistrer",del:"Supprimer",saved:"Recette enregistrée.",fail:"Échec de l’enregistrement.",meat:"Viande",soup:"Soupes",dough:"Pâtes",dessert:"Desserts",breakfast:"Petit-déjeuner",other:"Autres"},
